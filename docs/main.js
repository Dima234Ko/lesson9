...
/******/ (() => {
  ...
  \**********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        eval(
          '\nObject.defineProperty(exports, "__esModule", ({ value: true }));\n__webpack_require__(/*! ./body.css */ "./src/body.css");\n__webpack_require__(/*! ./table.css */ "./src/table.css");\n__webpack_require__(/*! ./btn.css */ "./src/btn.css");\nconst gameOfLife_1 = __webpack_require__(/*! ./gameOfLife */ "./src/gameOfLife.ts");\nconst events_1 = __webpack_require__(/*! ./events */ "./src/events.ts");\nconst game = new gameOfLife_1.GameOfLife();\ngame.initialize();\n// Инициализируем GameEvents после загрузки DOM\ndocument.addEventListener("DOMContentLoaded", () => {\n    new events_1.GameEvents(game); // Создаем экземпляр без сохранения в переменной\n});\n\n\n//# sourceURL=webpack://lesson9/./src/index.ts?',
        );
  ...
  \*********************/
      /***/ (__unused_webpack_module, exports) => {
        eval(
          '\nvar _a, _b;\nObject.defineProperty(exports, "__esModule", ({ value: true }));\nexports.height = exports.width = void 0;\nexports.updateDimensions = updateDimensions;\n// Начальные значения\nlet width = Number((_a = document.querySelector("#width")) === null || _a === void 0 ? void 0 : _a.value) || 10;\nexports.width = width;\nlet height = Number((_b = document.querySelector("#height")) === null || _b === void 0 ? void 0 : _b.value) || 10;\nexports.height = height;\n// Функция для обновления значений WIDTH и HEIGHT\nfunction updateDimensions() {\n    const widthInput = document.querySelector("#width");\n    const heightInput = document.querySelector("#height");\n    if (widthInput && heightInput) {\n        // Проверяем, что элементы существуют\n        exports.width = width = Number(widthInput.value);\n        exports.height = height = Number(heightInput.value);\n    }\n    else {\n        alert("Не удалось найти элементы ввода ширины или высоты.");\n    }\n}\n\n\n//# sourceURL=webpack://lesson9/./src/size.ts?',
        );
